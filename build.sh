...
${MAVEN_COMMAND} clean install -Dmaven.test.skip=true -f "${CWD}/karaf-jasypt-support/pom.xml"

rm -Rf /tmp/apache-maven*

cp ${CWD}/karaf-jasypt-support/target/*.jar "${ARTIFACTS_DIR}/karaf-jasypt-support.jar"
